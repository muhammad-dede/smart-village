...
<body id="kt_body"
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ url('img/150-2.jpg') }}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                            ...
                                            <div class="mb-3 mb-md-0 fw-bold">
                                                ...
                                                <div class="fs-6 text-gray-600 pe-7">Login into Aldoo Admin Dashboard
                    ...
                    <div class="d-flex justify-content-end mb-10">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ url('img/150-2.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::User-->
    ...
    <button id="kt_explore_toggle"
        class="btn btn-sm btn-white btn-active-primary shadow-sm position-fixed px-5 fw-bolder zindex-2 top-50 rounded-top-0 mt-10 end-0 transform-90 fs-6"
        title="Explore Aldoo" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-trigger="hover">
    ...
    <div id="kt_explore" class="bg-white" data-kt-drawer="true" data-kt-drawer-name="explore"
        ...
        <div class="card shadow-none w-100">
            ...
            <div class="card-header" id="kt_explore_header">
                <h3 class="card-title fw-bolder text-gray-700">Explore Aldoo</h3>
                <div class="card-toolbar">
                    <button type="button" class="btn btn-sm btn-icon btn-active-light-primary me-n5"
                        id="kt_explore_close">
                        <!--begin::Svg Icon | path: icons/duotone/Navigation/Close.svg-->
                    ...
                    <div class="mb-0">
                        ...
                        <div class="mb-7">
                            ...
                            <div class="overlay overflow-hidden border border-4 p-2 rounded">
                                ...
                                <div class="overlay-layer bg-dark bg-opacity-10">
                                    <div class="badge badge-light-primary px-6 py-4 fw-bold fs-base shadow">Coming
                                        soon
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card-footer py-5 text-center" id="kt_explore_footer">
                <a href="https://1.envato.market/EA4JP" class="btn btn-primary">Purchase Aldoo</a>
            </div>
            <!--end::Footer-->
        </div>
        <!--end::Card-->
