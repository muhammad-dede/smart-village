        ...
        <div data-kt-place="true" data-kt-place-mode="prepend"
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                @if ($sub_menu !== null)
                    ...
                    <li class="breadcrumb-item text-dark">{{ $sub_menu }}</li>
                @else
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
                    </li>
                        ...
                        <div class="mb-10">
                            ...
                            <div>
                                <select class="form-select form-select-solid select2-hidden-accessible"
                                    ...
                                    data-select2-id="select2-data-7-6hgi" tabindex="-1" aria-hidden="true">
                                    ...
                                    data-select2-id="select2-data-8-s6iq" style="width: 100%;"><span
                                        class="selection"><span
                                            class="select2-selection select2-selection--single form-select form-select-solid"
                                            role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                            aria-disabled="false" aria-labelledby="select2-9g79-container"
                                            aria-controls="select2-9g79-container"><span
                                                class="select2-selection__rendered" id="select2-9g79-container"
